...
type PanelType = 'chat' | 'agentManager' | 'claudeCode';
...
// Claude Code panel doesn't use OpenCode — skip the bootstrap overlay entirely.
const isClaudeCodePanel = window.__OPENCHAMBER_PANEL_TYPE__ === 'claudeCode';
if (isClaudeCodePanel) {
  import('@/main')
    .then(async () => {
