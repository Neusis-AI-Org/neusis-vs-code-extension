...
// Expose on window so cross-package components (e.g. ClaudeCodeView in @openchamber/ui) can post messages.
(window as unknown as { __OPENCHAMBER_VSCODE_API__: VSCodeAPI }).__OPENCHAMBER_VSCODE_API__ = vscode;
